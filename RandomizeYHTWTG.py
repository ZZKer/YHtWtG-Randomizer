...
def run_randomizer():
    ...
    Treasure = [(-10, 3, 'xxxx', 292, 36),  # 0
                ...
                (5, 4, 'xx1x', 284, 108), (5, 6, 'xxxx', 160, 124),  # 57-62
                (6, 1, '1x1x', 212, 84),  # 63
